...
public class AuthorSeeder implements EntitySeeder {
    ...
    public void seed() {
        ...
        authorRepository.save(Author.builder().firstName("Antoine").lastName("de Saint-Exupéry").build());
        authorRepository.save(Author.builder().firstName("J.R.R").lastName("Tolkien").build());
    }
