...
public class RatingController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<PageResponseDTO<Rating>>> findAll(
            Pageable pageable,
            @AuthenticationPrincipal UserDetails userDetails) {

        return ResponseEntity.ok(
                ApiResponse.success(
                        PageMapper.toDto(ratingService.findAll(pageable, userDetails)), "Avis recuperés avec succes")
        );
    ...
    public ResponseEntity<ApiResponse<Void>> delete(
        ...
        return ResponseEntity.ok(ApiResponse.success(null, "Avis supprimé avec succès"));
    }
